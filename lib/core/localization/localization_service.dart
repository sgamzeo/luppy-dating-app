...
import 'package:luppy_dating_app/core/constants/language_constants.dart';
import 'package:luppy_dating_app/core/localization/language_model.dart';
...
class LocalizationService extends GetxService {
    ...
    try {
      ...
      if (languageData != null) {
        ...
        if (localeNameList[0] == 'tr') {
          languageModel = LanguageConstants.languageModelTr;
        } else {
          languageModel = LanguageConstants.languageModelEn;
        }
      }
    } catch (e) {
      languageModel = LanguageConstants.languageModelEn;
  ...
  Locale _locale(String languageCode, String countryCode) {
    ...
    return (languageCode.isNotEmpty && countryCode.isNotEmpty)
        ...
        : Locale(
            LanguageConstants.languageModelEn.languageCode,
            LanguageConstants.languageModelEn.countryCode,
          );
  }
